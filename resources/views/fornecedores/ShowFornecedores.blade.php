<div class="modal fade modalbuscafornecedores" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
         ...
         <div class="table-responsive">
            <div class="card-body"> 
                <table id="tablebuscafornecedores" class="table table-hover table-striped shadow-xs rounded" style="width:100%">
                <thead>
                    <tr>
                        <th>Código</th>
                        <th>Fornecedor</th>

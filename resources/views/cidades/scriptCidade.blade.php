...
$(function(){
        ...
        $('.alterar').on('click', function(){
            ...
            $("#cidade_cidade").val(cidade); // inserir na o nome na pergunta de confirmação dentro da modal
            $("#cidade_ddd").val(cidade_ddd); // inserir na o nome na pergunta de confirmação dentro da modal
            $("#cidade_estado_id").val(cidade_estado_id); // inserir na o nome na pergunta de confirmação dentro da modal
            $("#cidade_estado").val(cidade_estado); // inserir na o nome na pergunta de confirmação dentro da modal

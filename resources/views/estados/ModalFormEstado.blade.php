<div id="modalestado" class="modal fade modalestado" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="card-header">
                <div class="modal-header align-items-center py-2 bg-dark">
                    <div class="d-flex align-items-center">                 
                        <h5 class="modal-titleestado" id="exampleModalLabel" style="color: white"> Cadastrar Estado</h5>
                      </div>
              ...
              <form name="createestado" id="ModalFormEstado" class="needs-validation" novalidate action=" " method="post">
                ...
                <div class="row">                    
                    <div class="col-12 text-right">
                      <button type="submit" class=" btn btn-dark  btn-sm btn-estado">SALVAR</button>
                      <button class="btn btn-sm btn-dark btn-voltar" data-dismiss="modal">VOLTAR</button>
                    </div>
                </div>
              </form>   
          </div>

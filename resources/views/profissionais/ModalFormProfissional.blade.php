<div class="modal fade modalprofissional" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="card-header">
                <div class="modal-header align-items-center py-2 bg-dark">
                    <div class="d-flex align-items-center">
                        ...
                        <h4 class="ml-3 mb-0 text-white">Cadastro Profissional</h4>
                    </div>
